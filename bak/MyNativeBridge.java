...
public class MyNativeBridge {
    ...
    private native Surface startNativeServerAndEncoder(int width, int height, int bitrate, int port);
    ...
    public void startMirroring(int width, int height, int bitrate, int port) throws IOException {
        ...
        mySurface = startNativeServerAndEncoder(width, height, bitrate, port);
